...
export function CommunityStoryForm({
  ...
  if (!isLoggedIn) {
    return (
      <div className="story-form login-required-panel">
        <p>
          Stuk Verdriet is een plek voor verhalen en vragen over rouw, verlies, ziekte, gemis en
          verder leven. Lees voor je meedoet de{' '}
          <Link href="/communityrichtlijnen">communityrichtlijnen</Link>.
        </p>
  ...
  return (
    <form
      className="form-grid story-form"
    ...
    >
      ...
      <label>
        ...
        <small>
          Optioneel. Deel bijvoorbeeld een hulporganisatie, artikel, boek of praktische bron.
        </small>
      </label>
      <label>
        Linktekst
