  ...
  return (
    <div className="login-under-construction">
      <div className="login-uc-content">
        <p className="eyebrow">{isShop ? "Shop" : "Community"}</p>
        <h1>{isShop ? "Shop afgeschermd" : "Community afgeschermd"}</h1>
        ...
        <form className="local-admin-login-form" action="/api/route-access" method="post">
          ...
          {params.error ? <p className="notice">Dat wachtwoord klopt niet.</p> : null}
        </form>
